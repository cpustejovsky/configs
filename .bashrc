...
alias gs='git status'
alias gu='git checkout master && git fetch origin && git merge origin/master'
alias ga='git add .'
alias gc='git commit'
alias pull='git checkout master && git pull origin master'
